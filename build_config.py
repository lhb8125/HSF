...
if PLATFORM == 'sw':
    ...
    cgns_home = software_home + '/CGNS/CGNS-3.4.0/sw_install_1_10_5'
    # hdf5_home = software_home + '/HDF5/hdf5-1.10.5/sw_build'
    hdf5_home = '/home/export/online3/amd_dev1/liuhb/software/hdf5-1.10.5'
